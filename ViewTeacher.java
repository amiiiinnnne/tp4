...
public class ViewTeacher extends JFrame{
    ...
    public JLabel lblName, lblSubject;
    public JTextField txtNom, txtSubject;
    ...
    Color tableRowColor=Color.decode("#E8F4FF");
        ...
        JLabel title=new JLabel("Gestion des enseignants", JLabel.CENTER);
        title.setFont(new Font("Segoe UI", Font.BOLD, 24));
        title.setForeground(primaryColor);
        add(title, BorderLayout.NORTH);
         tableModel=new DefaultTableModel(new Object[]{"ID","Nom","Subject"}, 0);
        ...
        gbc.gridx=0;
        gbc.gridy=2;
        panelForm.add(lblSubject, gbc);
        txtSubject=new JTextField();
        txtSubject.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        gbc.gridx=0;
        gbc.gridy=3;
        gbc.gridwidth=2;
        panelForm.add(txtSubject, gbc);
